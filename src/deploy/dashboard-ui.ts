    ...
    <section id="view-inspect" class="space-y-6">
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
          <input id="inspect-path-input" type="text" value="~/.gemini/config/plugins/mattpocock-skills" placeholder="e.g. ~/.gemini/config/plugins/mattpocock-skills, ~/.codex/plugins, or ." class="flex-1 bg-slate-950 border border-slate-700/80 rounded-lg px-4 py-2.5 text-sm text-slate-100 font-mono focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" />
        ...
        <div class="mt-4 pt-4 border-t border-slate-800 flex flex-wrap items-center gap-2 text-xs text-slate-400">
          ...
          <button onclick="selectSample('~/.gemini/config/plugins/mattpocock-skills')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition">mattpocock-skills</button>
          <button onclick="selectSample('~/.gemini/config/plugins/engineering')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition">engineering</button>
          <button onclick="selectSample('~/.gemini/config/plugins/data')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition">data</button>
          <button onclick="selectSample('~/.codex/plugins')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition">Codex Plugins (~/.codex/plugins)</button>
          <button onclick="selectSample('skills/migrate-agent-plugin')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition">migrate-agent-plugin</button>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            ...
            <div class="flex gap-2">
              <input id="convert-source-input" type="text" value="~/.gemini/config/plugins/mattpocock-skills" class="flex-1 bg-slate-950 border border-slate-700/80 rounded-lg px-3 py-2 text-sm text-slate-100 font-mono focus:outline-none focus:border-indigo-500" />
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl space-y-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-slate-400">Verifies system environment, target paths, and permissions across all client adapters.</p>
          </div>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl space-y-4">
        ...
        <div class="flex gap-2">
          <div class="flex-1 relative">
            ...
            <input id="cli-cmd-input" type="text" value="list" placeholder="list | doctor | inspect ~/.gemini/config/plugins/mattpocock-skills | docs" class="w-full bg-slate-950 border border-slate-700/80 rounded-lg pl-20 pr-4 py-2 text-sm text-slate-100 font-mono focus:outline-none focus:border-indigo-500" />
          </div>
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-2xl max-w-3xl w-full shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
      ...
      <div class="p-4 bg-slate-950 border-b border-slate-800 space-y-3">
        <div class="flex items-center gap-2 overflow-x-auto text-xs pb-1">
          ...
          <button onclick="browseDirectory('~/.gemini/config/plugins')" class="px-2.5 py-1 rounded bg-indigo-950/50 hover:bg-indigo-900/60 text-indigo-300 border border-indigo-500/30 font-mono transition shrink-0">✨ Antigravity Plugins (~/.gemini/config/plugins)</button>
          <button onclick="browseDirectory('~/.codex/plugins')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition shrink-0">🤖 Codex Plugins (~/.codex/plugins)</button>
          <button onclick="browseDirectory('~/.claude/plugins')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition shrink-0">🧠 Claude Plugins (~/.claude/plugins)</button>
          <button onclick="browseDirectory('~/.config/opencode/plugins')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition shrink-0">⚙️ OpenCode Plugins</button>
          <button onclick="browseDirectory('.agents/plugins')" class="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 font-mono transition shrink-0">📁 .agents/plugins</button>
  ...
  <script>
    ...
    function openDirectoryPicker(targetInput) {
      ...
      const initialPath = targetInput === 'inspect'
        ? (document.getElementById('inspect-path-input').value || '~/.gemini/config/plugins/mattpocock-skills')
        : (document.getElementById('convert-source-input')?.value || '~/.gemini/config/plugins/mattpocock-skills');
